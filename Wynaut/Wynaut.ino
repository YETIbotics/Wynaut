...
void loop() {
	...
	if (PS4.connected()) {
		...
		if (PS4.getAnalogHat(LeftHatY) > 137) {
			//Going backwards
			DriveLeftSpeed = map(PS4.getAnalogHat(LeftHatY), 137, 255, 0, -255);
		}
		else if (PS4.getAnalogHat(LeftHatY) < 117)
		{
			//going forwards
			DriveLeftSpeed = map(PS4.getAnalogHat(LeftHatY), 117, 0, 0, 255);
		}



		if (PS4.getAnalogHat(RightHatY) > 137) {
			DriveRightSpeed = map(PS4.getAnalogHat(RightHatY), 137, 255, 0, -255);
		}
		else if (PS4.getAnalogHat(RightHatY) < 117)
		{
			DriveRightSpeed = map(PS4.getAnalogHat(RightHatY), 117, 0, 0, 255);
		}
